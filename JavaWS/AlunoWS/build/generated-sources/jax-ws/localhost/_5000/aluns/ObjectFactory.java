 ...
 * generated in the localhost._5000.aluns package. 
...
public class ObjectFactory {
    ...
    private final static QName _Inserir_QNAME = new QName("http://localhost:5000/aluns", "inserir");
    private final static QName _Listar_QNAME = new QName("http://localhost:5000/aluns", "listar");
    private final static QName _AlterarResponse_QNAME = new QName("http://localhost:5000/aluns", "alterarResponse");
    private final static QName _InserirResponse_QNAME = new QName("http://localhost:5000/aluns", "inserirResponse");
    private final static QName _Remover_QNAME = new QName("http://localhost:5000/aluns", "remover");
    private final static QName _RemoverResponse_QNAME = new QName("http://localhost:5000/aluns", "removerResponse");
    private final static QName _ListarResponse_QNAME = new QName("http://localhost:5000/aluns", "listarResponse");
    private final static QName _Alterar_QNAME = new QName("http://localhost:5000/aluns", "alterar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: localhost._5000.aluns
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "inserir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "listar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "alterarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "inserirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "remover")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "removerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "listarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:5000/aluns", name = "alterar")
